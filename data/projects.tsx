...
export const projects: Project[] = [
  ...
  title: "Musix",
  emoji: "🎵",
  description: "Hybrid CF + embedding-based personalized music recommendions with mood-aware discovery.",
  ...
  highlights: [
    "Hybrid recommender combines collaborative signals + audio/metadata features for personalized Top-N.",
    "RAG enriches prompts with track metadata + listening history to generate grounded explanations.",
    "Edge caching + precomputed candidate sets deliver sub-100ms recommendation responses.",
  ],
  role: "Full-Stack",
  timeframe: "2024",
...
},
{
  ...
  title: "Moviez",
  emoji: "🎬",
  description: "Embedding-driven movie recommender using NLP features and Top-K re-ranking for relevant picks.",
  ...
  highlights: [
    "Semantic retrieval via embeddings (plot/genres/cast) to recommend ‘similar taste’ movies beyond keywords.",
    "Cold-start ranking blends content similarity with popularity priors to stabilize new-user recommendations.",
    "Feedback loop updates per-user similarity weights in real time (likes/skips) for faster personalization.",
  ],
  role: "Full-Stack",
  timeframe: "2024",
  category: "Full-Stack / AI / Recommender",
