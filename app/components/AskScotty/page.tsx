...
export default function AskScotty({ question }: { question: string }) {
  ...
  return (
    <>
      {/* Mobile/Tablet Button (sm and md screens) */}
      ...
      {/* Desktop Chat Window (lg screens only) */}
      <div
        ref={chatRef}
        className={`hidden lg:flex fixed bottom-4 right-4 z-40 flex-col glass-container dark transition-all duration-300 ease-out ${
